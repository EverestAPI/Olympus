...
namespace Olympus {
    public unsafe class CmdAhornInstallJulia : Cmd<bool, IEnumerator> {
        ...
        public static readonly string VersionBeta = "1.6.0-rc2";
        ...
        public override IEnumerator Run(bool beta) {
            ...
            if (PlatformHelper.Is(Platform.Windows)) {
                ...
                if (PlatformHelper.Is(Platform.Bits64)) {
                    url = beta ?
                        "https://julialang-s3.julialang.org/bin/winnt/x64/1.6/julia-1.6.0-rc2-win64.zip" :
                        "https://julialang-s3.julialang.org/bin/winnt/x64/1.5/julia-1.5.4-win64.zip";
                } else {
                    url = beta ?
                        "https://julialang-s3.julialang.org/bin/winnt/x86/1.6/julia-1.6.0-rc2-win32.zip" :
                ...
                try {
                    ...
                    using (FileStream zipStream = File.Open(zipPath, FileMode.Create, FileAccess.ReadWrite, FileShare.ReadWrite | FileShare.Delete)) {
                        ...
                        using (ZipArchive zip = new ZipArchive(zipStream, ZipArchiveMode.Read)) {
                            yield return Unpack(zip, julia, beta ? "julia-1.6.0-rc2/" : "julia-1.5.4/");
                        }
                    }
...
"
                ...
                if (PlatformHelper.Is(Platform.ARM)) {
                    url = beta ?
                        "https://julialang-s3.julialang.org/bin/linux/aarch64/1.6/julia-1.6.0-rc2-linux-aarch64.tar.gz" :
                        "https://julialang-s3.julialang.org/bin/linux/aarch64/1.5/julia-1.5.4-linux-aarch64.tar.gz";
                } else if (musl) {
                    url = beta ?
                        "https://julialang-s3.julialang.org/bin/musl/x64/1.6/julia-1.6.0-rc2-musl-x86_64.tar.gz" :
                    ...
                    url = beta ?
                        "https://julialang-s3.julialang.org/bin/linux/x64/1.6/julia-1.6.0-rc2-linux-x86_64.tar.gz" :
                        "https://julialang-s3.julialang.org/bin/linux/x64/1.5/julia-1.5.4-linux-x86_64.tar.gz";
                } else {
                    url = beta ?
                        "https://julialang-s3.julialang.org/bin/linux/x86/1.6/julia-1.6.0-rc2-linux-i686.tar.gz" :
                ...
                try {
                    ...
                    Directory.Move(Path.Combine(root, beta ? "julia-1.6.0-rc2" : "julia-1.5.4"), julia);
...
"
                ...
                string url = beta ?
                    "https://julialang-s3.julialang.org/bin/mac/x64/1.6/julia-1.6.0-rc2-mac64.dmg" :
