...
提示：禁用模组可以阻止 Everest 加载它，效果和删除一样能减少卡顿。]],
    ...
    update_everest_when_updating_mods = [[更新模组时同时更新 Everest]],
    everest_update_branch = [[Everest 更新分支]],
    branch_beta = [[测试版]],
    branch_dev = [[开发版]],
    an_error_occurred_while_updating_everest = [[更新 Everest 时发生错误：]],
    could_not_find_everest_build_for_branch = [[找不到「%s」分支的 Everest 构建。]],
    use_opengl = [[使用 OpenGL]],
    close_after_one_click_install = [[一键安装后关闭]],
    auto_enable_dependencies_on_download = [[下载时自动启用依赖项]],
