...
Tu peux aussi installer le runtime manuellement, puis réessayer d'installer Everest.]],
    ...
    most_recent = [[Tri par date de création]],
    last_updated = [[Tri par date de MàJ]],
    most_downloaded = [[Tri par téléchargements]],
    most_viewed = [[Tri par vues]],
    most_liked = [[Tri par likes]],
    all = [[Tous]],
...
Astuce : Si tu désactives le mod, Everest ne le chargera pas, ce qui est tout aussi efficace pour le lag.]],
    ...
    update_everest_when_updating_mods = [[Mettre à jour Everest lors de la mise à jour des mods]],
    everest_update_branch = [[Branche de mise à jour d'Everest]],
    branch_beta = [[Bêta]],
    branch_dev = [[Dev]],
    an_error_occurred_while_updating_everest = [[Une erreur est survenue lors de la mise à jour d'Everest : ]],
    could_not_find_everest_build_for_branch = [[Impossible de trouver une build d'Everest pour la branche « %s ».]],
...
- ]],
    ...
    ui_scale_default = [[100% (défaut)]],
    restart_to_apply_changes_in_ui_scale = [[Tu dois redémarrer Olympus pour que le changement d'échelle soit appliqué.]],
