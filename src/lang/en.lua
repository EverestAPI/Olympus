...
Tip: Disabling the mod prevents Everest from loading it, and is as efficient as deleting it to reduce lag.]],
    ...
    update_everest_when_updating_mods = [[Update Everest when updating mods]],
    everest_update_branch = [[Everest update branch]],
    branch_beta = [[Beta]],
    branch_dev = [[Dev]],
    an_error_occurred_while_updating_everest = [[An error occurred while updating Everest: ]],
...
- ]],
    ...
    ui_scale = [[UI Scale]],
    ui_scale_default = [[100% (Default)]],
    restart_to_apply_changes_in_ui_scale = [[You must restart Olympus for the UI scale change to take effect.]],
