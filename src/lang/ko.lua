...
팁: 모드를 비활성화하면 Everest가 해당 모드를 불러오지 않으며, 지연을 줄이는 효과는 삭제하는 것과 같습니다.]],
    ...
    france_risingsunlight = [[프랑스 (risingsunlight.dev)]],
    ...
    update_everest_when_updating_mods = [[모드를 업데이트할 때 Everest도 업데이트]],
    everest_update_branch = [[Everest 업데이트 브랜치]],
    branch_beta = [[베타]],
    branch_dev = [[개발]],
    an_error_occurred_while_updating_everest = [[Everest 업데이트 중 오류가 발생했습니다: ]],
    could_not_find_everest_build_for_branch = [["%s" 브랜치의 Everest 빌드를 찾을 수 없습니다.]],
...
- ]],
    ...
    ui_scale = [[UI 크기]],
    ui_scale_default = [[100% (기본값)]],
    restart_to_apply_changes_in_ui_scale = [[UI 크기 변경 사항을 완전히 적용하려면 Olympus를 다시 시작해야 합니다.]],
