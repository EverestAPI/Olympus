...
local en = {
    ...
    your_celeste_installation_list_is_still_ = [[
...
Do you want to go to the Celeste installation manager?]],
    ...
    do_you_want_to_close_olympus = [[
Do you want to close Olympus?]],
    the_olympus_app_is_out_of_date_sometimes = [[
...
If you are using Lutris or similar, you are on your own.]],
    celeste_or_something_looking_like_celest = [[
...
They should be removed before attempting to install Everest.
    ...
    nif_lua_is_ko_but_sharp_is_ok_deleting = "\nIf Lua is KO but Sharp is OK, deleting ",
...
- Network filtering is blocking the website, try again on another connection or toggle your VPN.]],
    ...
    you_can_ask_for_help_in_the_celeste_disc = [[
...
Before uploading, check your logs for sensitive info (f.e. your username).]],
    ...
    found = "Found",
    the_uwp_xbox_microsoft_store_version_of_ = [[
...
anything to work in the near future, if at all.]],
    verifying_the_file_integrity_will_tell_s = [[
...
Do you want to continue?]],
    olympus_needs_to_know_which_celeste_inst1 = [[
...
Manually select Celeste.exe if no installations have been found automatically.]],
    olympus_needs_to_know_which_celeste_inst2 = [[
Olympus needs to know which Celeste installations you want to manage.
You can add automatically found installations from the list below to this one.
]],
    olympus_needs_to_know_which_celeste_inst3 = [[
Olympus needs to know which Celeste installations you want to manage.
No installations were found automatically. Manually select Celeste.exe to add it to Olympus.
    ...
    ahorn = "Ahorn",
    your_celeste_installation_list_is_empty_ = [[
Your Celeste installation list is empty.
Do you want to go to the Celeste installation manager?]],
    your_celeste_installs_list_is_empty_pres = [[
...
Press the manage button below.]],
    ...
    are_you_sure_that_you_want_to_delete = [[
...
Tip: Disabling the mod prevents Everest from loading it, and is as efficient as deleting it to reduce lag.]],
    ...
    this_is_your_current_theme_the_quick_bro = [[
This is your current theme.
The quick brown fox jumps]],
    this_is_the_new_theme_over_the_lazy_dog = [[
...
- ]],
    can_help_if_the_install_everest_or_downl = [[ can help if the "Install Everest" or "Download Mods" pages won't load. The mod browser will be slower and more resource-intensive, though!
- ]],
...
local fr = {
    ...
    your_celeste_installation_list_is_still_ = [[
Ta liste d'installations de Celeste est toujours vide.
Veux-tu aller au gestionnaire d'installations ?]],
    ...
    do_you_want_to_close_olympus = [[
Veux-tu fermer Olympus ?]],
    the_olympus_app_is_out_of_date_sometimes = [[
L'application Olympus n'est pas à jour.
...
Ne pas mettre à jour Olympus pourrait causer des plantages à l'avenir.]],
    ...
    there_is_a_new_version_available_update = [[
Une nouvelle version d'Olympus est disponible.
Veux-tu installer la version %s maintenant ?]],
    there_is_a_new_version_available = [[
Une nouvelle version d'Olympus est disponible : %s]],
    ...
    celeste_is_already_starting_up_please_wa = [[
Celeste est déjà en train de démarrer.
Tu peux fermer cette fenêtre.]],
    celeste_is_now_starting_in_the_backgroun = [[
Celeste est en train de démarrer en arrière-plan.
Tu peux fermer cette fenêtre.]],
    everest_is_now_starting_in_the_backgroun = [[
Everest est en train de démarrer en arrière-plan.
Tu peux fermer cette fenêtre.]],
    olympus_couldn_t_find_the_celeste_launch = [[
Olympus n'a pas pu trouver l'exécutable de Celeste.
...
Si tu utilises Lutris ou un outil similaire, on ne peut pas t'aider.]],
    celeste_or_something_looking_like_celest = [[
Celeste (ou quelque chose qui y ressemble) est déjà en cours d'exécution.
...
Veux-tu ouvrir un autre exemplaire quand même ?]],
    ...
    uninstall_dialog = [[
La désinstallation d'Everest conservera tous tes mods,
...
Utilise la dernière version ]],
    ...
    your_current_version_of_celeste_is_outda = [[
Ta version de Celeste n'est pas à jour.
Installe la dernière version du jeu avant d'installer Everest.]],
    residual_files_from_a_net_core_build_hav = [[
Des fichiers résiduels d'une version .NET Core ont été détectés.
...
Il faudrait les supprimer avant d'installer Everest.
    ...
    gamebanana_files = "GameBanana Files",
    nif_lua_is_ko_but_sharp_is_ok_deleting = "\nSi Lua est KO mais Sharp is OK, supprimer ",
...
- Un filtrage réseau bloque le site, essaie sur un autre réseau ou utilise un VPN.]],
    ...
    you_can_ask_for_help_in_the_celeste_disc = [[
Tu peux demander de l'aide sur le serveur Discord Celeste (en anglais).
...
comme ton nom d'utilisateur.]],
    ...
    the_uwp_xbox_microsoft_store_version_of_ = [[
La version UWP (Xbox/Microsoft Store) de Celeste n'est pas supportée actuellement.
...
cette version du jeu, il ne faut pas s'attendre à quoi que ce soit...]],
    verifying_the_file_integrity_will_tell_s = [[
La vérification des fichiers du jeu va demander à Steam de re-télécharger
...
Veux-tu continuer ?]],
    olympus_needs_to_know_which_celeste_inst1 = [[
Olympus a besoin de savoir quelles installations de Celeste il doit gérer.
...
Aucune installation n'a été trouvée automatiquement. Sélectionne Celeste.exe manuellement.
    ...
    ncheck_the_readme_for_usage_instructions = "\nLis le README pour des instructions, les raccourcis clavier, etc :",
    ...
    ahorn = "Ahorn",
    your_celeste_installation_list_is_empty_ = [[
Ta liste d'installations de Celeste est vide.
...
Astuce : Si tu désactives le mod, Everest ne le chargera pas, ce qui est tout aussi efficace pour le lag.]],
    ...
    this_is_your_current_theme_the_quick_bro = [[
Ceci est ton thème actuel.
The quick brown fox jumps]],
    this_is_the_new_theme_over_the_lazy_dog = [[
Ceci est ton nouveau thème.
over the lazy dog.]],
...
local function get(key)
    ...
    if lang == "ne" then
        local value = en[key]:gsub("ö", "oe")
        value, _ = value:reverse():gsub("%%", "$")
